...
module.exports = {
    ...
    execute: async (client, message, args, prefix, guild, color, channel) => {
        ...
        if (!user || !user.pokemons[0]) return message.channel.send(`> <:x_mark:868344397211787275> **You must pick your starter pokémon with \`${nguild.prefix}start\` before using this command.**`);
